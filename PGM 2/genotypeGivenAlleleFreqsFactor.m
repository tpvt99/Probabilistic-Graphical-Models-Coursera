...
for i = 1:prod(genotypeFactor.card)
    allelesID = genotypesToAlleles(i,:);
    allelesProd = alleleFreqs(allelesID(1)) * alleleFreqs(allelesID(2));
    noAllele = sum(sum(allelesToGenotypes == i));
    allelesProd = noAllele * allelesProd;
    genotypeFactor.val(i) = allelesProd;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  