...
for i = 1:numPeople
    ...
    if sum(pedigree.parents(i,:)) == 0
        ...
        factorList(i) = childCopyGivenParentalsFactor(numAlleles,... 
        i, pedigree.parents(i,1), pedigree.parents(i,1)+numPeople);
    end
    ...
    if sum(pedigree.parents(i,:)) == 0
        ...
        factorList(i+numPeople) = childCopyGivenParentalsFactor(numAlleles,... 
        i+numPeople, pedigree.parents(i,2), pedigree.parents(i,2)+numPeople);
    end
    
    %Compute Phenotype
    factorList(i+2*numPeople) = phenotypeGivenCopiesFactor(alphaList,... 
    numAlleles, i, i+numPeople, i+2*numPeople);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  