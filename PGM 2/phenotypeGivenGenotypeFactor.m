...
phenotypeFactor.card = [2, noGenotypes];

phenotypeFactor.val = zeros(1, prod(phenotypeFactor.card));
% Replace the zeros in phentoypeFactor.val with the correct values.
for i = 1:noGenotypes
    assign = IndexToAssignment(i*2-1, phenotypeFactor.card);
    phenotypeFactor = SetValueOfAssignment(phenotypeFactor, assign, alphaList(i));
    
    assign = IndexToAssignment(i*2, phenotypeFactor.card);
    phenotypeFactor = SetValueOfAssignment(phenotypeFactor, assign, 1-alphaList(i));
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%